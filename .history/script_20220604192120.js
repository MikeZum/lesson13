...
const appData = {
  ...
  asking: function () {
    ...
    appData.appData.adaptive = confirm("Нужен ли адаптив на сайте?");
    appData.appData.allServicePrices = appData.getAllServicePrices();
    appData.appData.fullPrice = appData.getFullPrice();
    appData.appData.servicePercentPrice = appData.getServicePercentPrice();
  },
